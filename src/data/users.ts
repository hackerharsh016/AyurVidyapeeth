...
export const mockUsers: User[] = [
  ...
  },
  {
    id: 'admin1',
    name: 'Admin',
    email: 'admin@srotaayurveda.com',
    college: 'Srotaayurveda',
    year: 'Admin',
    role: 'admin',
    avatar: 'SA',
...
export const testimonials = [
  {
    ...
    year: 'Intern',
    quote: 'Srotaayurveda has completely transformed how I study. The structured Srotas encyclopedia and expert courses helped me crack my finals with confidence.',
    rating: 5,
    avatar: 'SA',
  },
  {
